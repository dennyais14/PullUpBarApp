const DB = (() => {
  ...
  const exercises = [
    ...
    ex('Chin Up','Back, Biceps','assets/images/chin-upwebp','Presa supina, petto alto, evita oscillazioni.'),
    ex('Neutral Grip Pull Up','Back, Biceps','assets/images/neutral-grip-pull-upwebp','Presa neutra e gomiti verso il basso.'),
    ...
    ex('Inverted Row','Back, Biceps','assets/images/inverted-rowwebp','Corpo in linea, tira il petto verso la barra.'),
    ex('Strict Inverted Row','Back, Biceps','assets/images/strict-inverted-row.webp','Glutei e core contratti, niente slancio.'),
    ex('Strict Underhand-Grip Inverted Row','Back, Biceps','assets/images/strict-underhand-grip-inverted-rowwebp'),
    ...
    ex('Dips','Triceps, Chest, Shoulders','assets/images/dipswebp','Petto alto, gomiti controllati, scendi senza fastidio alle spalle.'),
    ex('High Straight-Bar Dip','Triceps, Chest, Shoulders','assets/images/high-straight-bar-dipwebp'),
...
function renderAll(){ updatePathwayUI(); if(!S.onboarded) return; renderDashboard(); renderProgram(); renderGuided(); renderLibrary(); renderCardio(); renderTests(); renderProgress(); renderStretching(); renderHistory(); renderSettingsScreen(); }
